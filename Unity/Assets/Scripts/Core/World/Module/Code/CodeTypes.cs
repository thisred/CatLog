...
namespace ET
{
    public class CodeTypes : Singleton<CodeTypes>, ISingletonAwake<Assembly[]>
    {
        ...
        private readonly List<Type> cacheTypes = new();
        ...
        public void Awake(Assembly[] assemblies)
        {
            ...
            foreach ((string fullName, Type type) in addTypes)
            {
                ...
                if (typeof(ICache).IsAssignableFrom(type) && type != typeof(ICache))
                {
                    this.cacheTypes.Add(type);
                }
            }
        }
        ...
        public void CreateCode()
        {
            ...
            foreach (Type type in hashSet)
            {
                ...
                GameRoot.Instance.AddSingleton((ASingleton)obj);
            }
        }
    }
}