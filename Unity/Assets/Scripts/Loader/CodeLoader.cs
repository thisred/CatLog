...
namespace ET
{
    public class CodeLoader: Singleton<CodeLoader>, ISingletonAwake
    {
        ...
        public void Start()
        {
            ...
            GameRoot.Instance.AddSingleton<CodeTypes, Assembly[]>(new[]
            {
                typeof (GameRoot).Assembly, typeof (Init).Assembly, this.modelAssembly, this.modelViewAssembly, hotfixAssembly,
                hotfixViewAssembly
            });
        ...
        public void Reload()
        {
            ...
            CodeTypes codeTypes = GameRoot.Instance.AddSingleton<CodeTypes, Assembly[]>(new[]
            {
                typeof (GameRoot).Assembly, typeof (Init).Assembly, this.modelAssembly, this.modelViewAssembly, hotfixAssembly,
                hotfixViewAssembly
            });
