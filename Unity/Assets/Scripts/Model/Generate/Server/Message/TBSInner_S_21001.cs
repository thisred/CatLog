...
namespace ET
{
    ...
    /// </summary>
    [MemoryPackable]
    [Message(TBSInner.G2Match_Match)]
    ...
    [MemoryPackable]
    [Message(TBSInner.Match2G_Match)]
    ...
    [MemoryPackable]
    [Message(TBSInner.G2Match_CancelMatch)]
    ...
    [MemoryPackable]
    [Message(TBSInner.Match2G_CancelMatch)]
    ...
    [MemoryPackable]
    [Message(TBSInner.Match2Map_GetRoom)]
    ...
    [MemoryPackable]
    [Message(TBSInner.Map2Match_GetRoom)]
    ...
    [MemoryPackable]
    [Message(TBSInner.G2Room_Reconnect)]
    ...
    [MemoryPackable]
    [Message(TBSInner.Room2G_Reconnect)]
    public partial class Room2G_Reconnect : MessageObject, IResponse
    {
        ...
        [MemoryPackOrder(4)]
        public List<TBSUnitInfo> UnitInfos { get; set; } = new();
    ...
    [MemoryPackable]
    [Message(TBSInner.RoomManager2Room_Init)]
    ...
    [MemoryPackable]
    [Message(TBSInner.Room2RoomManager_Init)]
    ...
    [MemoryPackable]
    [Message(TBSInner.Room2G_RoomDispose)]
    public partial class Room2G_RoomDispose : MessageObject
    {
        public static Room2G_RoomDispose Create(bool isFromPool = false)
        {
            return ObjectPool.Instance.Fetch(typeof(Room2G_RoomDispose), isFromPool) as Room2G_RoomDispose;
        }
    ...
    public static class TBSInner
    {
        public const ushort G2Match_Match = 21002;
        public const ushort Match2G_Match = 21003;
        public const ushort G2Match_CancelMatch = 21004;
        public const ushort Match2G_CancelMatch = 21005;
        public const ushort Match2Map_GetRoom = 21006;
        public const ushort Map2Match_GetRoom = 21007;
        public const ushort G2Room_Reconnect = 21008;
        public const ushort Room2G_Reconnect = 21009;
        public const ushort RoomManager2Room_Init = 21010;
        public const ushort Room2RoomManager_Init = 21011;
        public const ushort Room2G_RoomDispose = 21012;
    }
}